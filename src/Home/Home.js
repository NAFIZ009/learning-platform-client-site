    ...
    return (
        <div className="hero min-h-screen w-full">
            <div className="hero-content flex-col lg:flex-row-reverse ">
                <img src="https://img.freepik.com/free-vector/developer-activity-concept-illustration_114360-2801.jpg?w=740&t=st=1666724627~exp=1666725227~hmac=8b40b131e95e4feba06ea763faf0b52a499b33dfd90b7d0764d3b6425e7f3bd7" className="lg:w-4/12 rounded-lg shadow-2xl" alt='coverImg' />
                <div>
